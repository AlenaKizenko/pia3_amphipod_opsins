...
def run_transdecoder(file, out_dir):
    ...
    transdecoder_cds = f'{out_dir}/{base_name}.transdecoder.cds'  # define the name of Transdecoder's result file with cds
...
def rename_hits(species_name, out_dir, transcripts, db):
